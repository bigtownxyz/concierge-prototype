...
export const PROGRAMS: Program[] = [
  ...
  },
  {
    ...
    requirements: ["Clean criminal record", "Proof of funds", "Health certificate", "Due diligence clearance"],
    radarScores: { cost_score: 90, speed_score: 55, lifestyle_score: 40, tax_score: 70, travel_score: 35 },
    excludedNationalities: ["IR", "KP", "RU", "BY"],
  ...
  },
  {
    ...
    requirements: ["Clean criminal record", "Proof of funds", "Health certificate", "Due diligence clearance"],
    radarScores: { cost_score: 78, speed_score: 95, lifestyle_score: 55, tax_score: 90, travel_score: 55 },
  ...
  },
  {
    ...
    requirements: ["Clean criminal record", "Proof of funds", "Health certificate", "Due diligence clearance"],
    radarScores: { cost_score: 88, speed_score: 65, lifestyle_score: 38, tax_score: 65, travel_score: 40 },
    excludedNationalities: ["IR", "KP", "RU", "BY"],
