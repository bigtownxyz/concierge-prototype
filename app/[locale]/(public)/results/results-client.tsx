...
export default function ResultsClient({ userId }: { userId: string }) {
  ...
  useEffect(() => {
    ...
    async function fetchData() {
      // Auth and the enquiry-vs-quiz routing guard are enforced server-side
      // by the page (results/page.tsx). This client only ever renders for an
      // authed quiz user, so it fetches display data directly against userId.
